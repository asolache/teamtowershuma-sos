...
// v128 · 'skills' tab eliminat · era un landing duplicat de /skills (catàleg
// complet). Reduïm soroll · cada tab té un cost cognitiu i el seu propi
// destinaten valuós · skills viu fora amb la seva pàgina pròpia.
...
export default class LearnView {
    ...
    // v128 · _renderSkillsTab ELIMINAT · era un landing duplicat de /skills
    // (catàleg complet). Les skills viuen ara només a /skills com a destinació
    // única i clara · zero soroll al hub /learn.
