    ...
    async getHtml() {
        ...
        <div class="sp-shell"><div class="sp-main">
            <header class="sp-hero">
                ...
                <!-- v156 · Deprecation banner · /sprint serà eliminat · funcionalitat migrada al /kanban (autonomous loop in-place) -->
                <div style="padding:10px 14px;background:rgba(245,158,11,0.12);border:1px solid rgba(245,158,11,0.4);border-radius:6px;margin-bottom:0.8rem;font-size:0.85rem;line-height:1.55;color:#fbbf24;">
                    ⚠ <strong>DEPRECATED · /sprint serà eliminat aviat</strong> · Funcionalitat migrada al <a href="/kanban?project=sos-dev-internal" data-link style="color:#fbbf24;font-weight:700;text-decoration:underline;">/kanban?project=sos-dev-internal</a> · botó <strong>🤖 Run autonomous loop</strong> al toolbar processa WOs IA in-place · output queda vinculat a cada WO (millor UX · sense /sprint volàtil). Els <code>sprint_run</code> nodes existents queden accessibles via història però els nous loops es persisteixen com a <code>aiOutput</code> a la WO.
                </div>
