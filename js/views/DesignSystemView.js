...
const BUILD_STAMP = '2026-05-19T00:30 · v162 · CANVAS+PITCH verna-style · METASKILL preamble injectat automàticament per personalize-canvas/pitch/landing en verna-minimal+verna-guided (Misió/Visió/Objectius derivats PRIMER · prohibició vocabulari genèric "qualitat"·"innovació"·"excel·lència" sense substantivar) · design-value-map-verna NO rep doble preamble (ja té el seu propi) · expertChainOrchestrator propaga contextProfile a totes les fases (single + per-item + escalation full) · 18 asserts v162 · ZERO regressions sos-current · prep · ara qualsevol caller pot demanar verna-guided per al chain complet · proper · Anchoring Lab estès a canvas + SOC shape eval propi · v161 · v161 · KISS prep next skills · FIX verna-guided no-op (ara conserva codi CNAE com a hint abstracte vs verna-minimal que també strippa sector) · FIX fewshot_overlap detector exact-match→landmark substring (paraules >4 chars · sense generics tipus founder/manager) · captures "Visioner"·"Arquitecte"·"Cohort" als outputs · cross-language limit conegut (anchor EN vs ancoratge CA) · 14 asserts v161 · ZERO regressions v160 · prep skill SOCs/Canvas/Pitch/Presentation-v2 amb mateixa filosofia METASKILL-first · v160 · ANTI-ANCHORING · Skill Claude de @alvaro replicada · NOU SYSTEM_BASE_VERNA (~762 tk · -48% vs SYSTEM_BASE) ancorat en METASKILL (misió/visió/objectius) · ZERO exemples literals · tipologies tangible/intangible ABSTRACTES (5+8 categories) · 4 principis VNA (reciprocitat · emergència · rols faltants · multiplicadors) · casteller levels com a SLOTS SENSE typical_kinds · NOU task design-value-map-verna metaskill-first amb missing_roles + needs_clarify + health_signals · NOU flag contextProfile a buildPrompt (sos-current · verna-minimal · verna-guided) · verna-* fa strip de domainDetection + sectorContext + sectorSeed + currentTemplate + fewShot (les 4 fonts d\'anchoring identificades a v159 audit) · quickSuggestMap + runValueMapCycle propaguen contextProfile · NOVA SECCIÓ "VNA Anchoring Lab" a /prompts-debug · 5 projectes diversos × 3 perfils en paral·lel · mètriques fewshot_overlap (↓ better) · cross_project_diversity (↑ better) · shape eval score · 38 asserts v160';
