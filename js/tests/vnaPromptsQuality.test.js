...
ok('A · principi 1 · ROLES actors actius', SYSTEM_BASE.includes('ROLES') && SYSTEM_BASE.includes('actors actius'));
ok('A · principi 2 · TRANSACTIONS flows direccionals', SYSTEM_BASE.includes('TRANSACTIONS') && SYSTEM_BASE.includes('flows direccionals'));
ok('A · principi 3 · TANGIBLE + INTANGIBLE',      SYSTEM_BASE.includes('TANGIBLE') && SYSTEM_BASE.includes('INTANGIBLE'));
ok('A · principi 4 · DELIVERABLES identitat pròpia',  SYSTEM_BASE.includes('DELIVERABLES') && SYSTEM_BASE.includes('identitat pròpia'));
ok('A · principi 5 · PATTERN RECÍPROC',  SYSTEM_BASE.includes('PATTERN RECÍPROC'));
