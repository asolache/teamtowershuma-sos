...
export const INITIAL_BACKLOG = Object.freeze([
    ...
    Object.freeze({
        ...
        description: 'Al detail view (/n/{nodeId}) · panel "Trust" amb llistat d\'attesters + statements + verify signatures inline. Closes Web of Trust pillar.',
        ...
        dependencies: ['trust-001'],
        testRequirements: [],
        suggestedFiles: ['js/views/NodeView.js'],
    }),
    Object.freeze({
