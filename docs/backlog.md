...
| **H1.10.4** | **Vista/edición de SOPs generados por IA** (panel en `/map` o vista dedicada `/sops?project=`) — listar SOPs propios del proyecto, ver MD/JSON, editar inline, regenerar con feedback. Input @alvaro 2026-04-30: "cuando se han generado debería poder ser visible y posiblemente editable como cualquier contenido generado por IA". | 🟡 |
